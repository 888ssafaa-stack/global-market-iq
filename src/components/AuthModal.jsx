...
import { X, LogIn, UserPlus, Mail, Lock, User, Phone, CheckCircle, Eye, EyeOff, Sparkles } from 'lucide-react';
    ...
    <div className="modal-overlay">
      <div className="modal-content" style={{ maxWidth: '460px', width: 'min(92vw, 460px)', borderRadius: '20px', overflow: 'hidden' }}>
        ...
        <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '14px', padding: '24px' }}>
          ...
          {/* 1️⃣ الخيار الأول: الدخول المباشر المبتكر بـ Google */}
          <button
            type="button"
          ...
          >
            ...
            <span>{isLoading ? 'جاري الدخول...' : 'متابعة بضغطة زر عبر Google 🚀'}</span>
          </button>

          {/* فاصل تنظيمي */}
          <div style={{ display: 'flex', alignItems: 'center', margin: '4px 0' }}>
            <div style={{ flex: 1, borderBottom: '1px solid #E5E7EB' }}></div>
            <span style={{ padding: '0 10px', color: '#9CA3AF', fontSize: '12px', fontWeight: '600' }}>أو بالبريد الإلكتروني المباشر</span>
            <div style={{ flex: 1, borderBottom: '1px solid #E5E7EB' }}></div>
          </div>

          {/* 2️⃣ الخيار الثاني: نموذج البريد الإلكتروني وكلمة المرور المباشر */}
          <form onSubmit={handleSubmitEmail} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            >
              {isLoading ? 'جاري التنفيذ...' : (isRegister ? 'إنشاء الحساب الآن' : 'تسجيل الدخول بالبريد')}
            </button>
          </form>
